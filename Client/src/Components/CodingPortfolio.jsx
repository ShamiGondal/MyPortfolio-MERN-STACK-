    ...
    return (
        <div id='blur-container'>
            <Helmet>
                ...
                Bring your digital ideas to life with [Ehtisham Ahmed Gondal], a skilled and passionate developer crafting solutions that captivate and engage. Masterful command of [React Native , C++, e.g., MERN Stack, React Native, C++]A proven track record of building captivating [types of projects you build, e.g., web applications, mobile apps, games].An unwavering commitment to exceeding expectations and delivering exceptional results" />
                <meta name="keywords" content="web developer, [Lahore JoharTown]
                mobile developer, [Lahore JoharTown]
                React Native developer, [Lahore JoharTown]
                MERN Stack developer, [Lahore JoharTown]
                freelance developer, [Lahore JoharTown], web developer shami gondal, game developer shami gondal , app developer shami gondal, game developer Ehtisham Ahmed gondal, app developer Ehtisham Ahmed gondal, web developer Ehtisham Ahmed gondal
            ...
            >
                <h2 className="text-center font-bold text-2xl mb-4 font-serif text-black mt-20 z-50">Coding Portfolio <i class="fa-solid fa-code"></i></h2>
